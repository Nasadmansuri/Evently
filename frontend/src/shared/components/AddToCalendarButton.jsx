  ...
  return (
    ...
    >
      <button
        ...
        className={`skeuo-btn-secondary inline-flex items-center justify-center gap-1.5 rounded-xl font-bold cursor-pointer min-h-[38px] ${isSmall ? 'px-3 py-1.5 text-[11.5px]' : 'px-4 py-2 text-xs min-h-[42px]'
          }`}
      >
