  ...
  return (
    ...
    >
      <button
        ...
        className={`inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white font-bold text-slate-700 shadow-xs hover:bg-slate-50 active:scale-95 transition ${
          isSmall ? 'px-3 py-1.5 text-[11.5px]' : 'px-4 py-2.5 text-xs'
        }`}
      >
