    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="evently-hero-banner rounded-2xl p-6 sm:p-7 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
          <div className="space-y-2.5 max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-400/20 backdrop-blur-md border border-emerald-300/30 px-3 py-1 text-xs font-bold text-emerald-200 shadow-2xs">
                <GraduationCap size={14} className="text-emerald-300 shrink-0" />
                {getStudentCourseLabel(user) || 'BSc (Hons) Computer Science'}
              </span>
            </div>
          </div>
          ...
          >
            <CalendarDays size={16} className="text-primary-700" /> Explore All Events <ArrowRight size={14} className="text-primary-700" />
          </button>
        </div>
      </div>
      ...
      {/* 3. Main 2-Column Section: Registered Events & Quick Actions */}
          ...
          <div className="skeuo-card rounded-2xl p-5 sm:p-6">
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pb-3 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">Your personal campus participation log</p>
              </div>

              {/* Segmented Control / Skeuomorphic Tab Tray */}
            ...
            {loading ? (
              ...
              <div className="py-10 px-5 text-center flex flex-col items-center justify-center bg-slate-50/70 rounded-2xl border border-dashed border-slate-200/90">
                ...
                {activeTab === 'upcoming' && (
                  <button
                    onClick={() => navigate('/events')}
                    className="mt-4 rounded-xl bg-primary-700 hover:bg-primary-800 text-white font-bold text-xs px-4 py-2.5 shadow-xs active:scale-95 transition-all cursor-pointer"
                  >
            ...
            {displayedEvents.length > 4 && (
              <div className="mt-4 pt-3 border-t border-slate-100 text-center">
                <button
                  ...
                  className="text-xs font-bold text-primary-700 hover:underline inline-flex items-center gap-1 cursor-pointer"
                >
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-slate-200/90 bg-white p-5 sm:p-6 shadow-2xs">
            ...
            <div className="space-y-2.5">
              ...
              <button
                onClick={() => navigate('/events')}
                className="w-full flex items-center justify-between rounded-xl bg-primary-700 hover:bg-primary-800 active:bg-primary-900 p-4 text-left shadow-xs hover:shadow-md active:scale-[0.98] transition-all cursor-pointer group"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-between rounded-xl border border-slate-200 bg-white hover:bg-slate-50 p-3.5 text-left shadow-2xs hover:border-primary-300 active:scale-[0.98] transition-all cursor-pointer group"
              >
                <div className="flex items-center gap-3">
  ...
  return (
    <div className="rounded-2xl border border-slate-200/90 bg-white p-5 sm:p-6 shadow-2xs">
      <div className="mb-4">
        ...
        <p className="text-xs text-slate-500 font-medium">Personalized events based on your department</p>
      </div>
          ...
          {events.map((ev) => {
            ...
            return (
              <button
                key={ev.id}
                onClick={() => navigate(`/events/${ev.id}`)}
                className="group rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 text-left transition-all duration-200 hover:bg-white hover:border-primary-300 hover:shadow-xs active:scale-[0.98] cursor-pointer"
              >
                <span className={`rounded-md px-2 py-0.5 text-[10px] font-bold ${style.bg} ${style.text}`}>
                  {ev.category}
                </span>
