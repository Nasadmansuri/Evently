...
export default function FacultySignup() {
  ...
  return (
    <div className="min-h-dvh lg:h-dvh lg:max-h-dvh bg-[#edf0f5] p-2.5 sm:p-3 md:p-4 selection:bg-primary-600 selection:text-white flex items-center justify-center overflow-y-auto lg:overflow-hidden max-lg:py-6">
      {/* Master Dual-Column Container */}
      <div className="w-full max-w-[1400px] h-auto lg:h-[calc(100dvh-2.5rem)] lg:max-h-[860px] bg-white rounded-[28px] sm:rounded-[36px] shadow-2xl border border-slate-200/90 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-10 py-4 sm:py-6 h-full max-lg:h-auto max-w-[480px] mx-auto w-full overflow-y-auto no-scrollbar">
